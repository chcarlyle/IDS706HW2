...
pf_df_polars = pl.read_csv("data/openpowerlifting.csv", dtypes={"Age": pl.Float64})
# Inspect data
print(pf_df.head())
...
# Filter polars
sbd_df_polars = pf_df_polars.filter(
...
y, X_train, X_test, y_train, y_test, model = default_model(
    sbd_df_polars, ["BodyweightKg"], ["Sex", "Equipment", "AgeClass"], ["TotalKg"]
)
